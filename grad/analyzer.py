...
import pdfplumber
import io
from grad.gpt_client import ask_gpt
...
with open(os.path.join(DATA_DIR, "cse_grad_2019_2025.json"), "r", encoding="utf-8") as f1, \
     open(os.path.join(DATA_DIR, "swcon_grad_2019_2025.json"), "r", encoding="utf-8") as f2, \
     open(os.path.join(DATA_DIR, "ai_grad_2022_2025.json"), "r", encoding="utf-8") as f3:
